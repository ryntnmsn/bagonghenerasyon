<template>
    <div class="mb-6 flex flex-col group">
        ...
        <input
            ...
            :type="type"
            v-model="model"
            class="border-2 outline-none text-gray-800 border-gray-100 bg-gray-50 w-full p-2 text-base rounded-md duration-400 ease-in-out focus:border-red ring-0 focus:bg-white"
        />
